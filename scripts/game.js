function resetGame() {
    ...
    for (let i = 0; i < 3; i++) {
        for (let x = 0; x < 3; x++) {
            gameData[i][x] = 0;
            const gameFieldItemElement = gameFieldElement.children[gameFieldIndex];
...
function selectGamenField(event) {
    ...
    gameData[selectedRow][selectedColumn] = activePlayer + 1;   //to set first player to 1 and second to 2, because defult is 0
